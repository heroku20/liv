! function() {
    var t = {
                ...
                ! function(e, o) {
                    ...
                    o.addResizeCallback = function(t, e) {
                        ...
                        o.$window.off("resize.tar").on("resize.tar", (function() {
                            o.$window.width() !== t && (e.each(i, (function(t, e) {
                                e.call(e.$$scope || this)
                            })), t = o.$window.width())
                        }))
                    }
            ...
            26660: function(t) {
                var e, o, i;
                e = ThriveGlobal.$j, o = TCB_Front, i = [], o.add_scroll_callback = function(t, e) {
                    return -1 === i.indexOf(t) && (t.$$scope = e, i.push(t)), o
                }, t.exports = function() {
                    var t = o.$document.scrollTop(),
                        n = "";
                    o.$window.off("scroll.tar").on("scroll.tar", (function() {
                        var r = o.$document.scrollTop(),
                            s = r >= t ? "down" : "up",
                            a = n !== s;
                        t = r, n = s, e.each(i, (function(t, e) {
                            e.call(e.$$scope || this, r, s, a)
                        }))
                    ...
                    e.prototype = {
                        ...
                        init: function(t) {
                            ...
                            function o() {
                                ...
                                e.shuffle && (e.sequence = e.shuffleArray(e.sequence)), "delete" === t ? (e.strPos = e.strings[e.sequence[e.arrayPos]].length, e.options.highlightClass ? e.highlight(e.strings[e.sequence[e.arrayPos]], e.strPos) : e.backspace(e.strings[e.sequence[e.arrayPos]], e.strPos)) : (e.strPos = 0, e.typewrite(e.strings[e.sequence[e.arrayPos]], e.strPos))
                            }
                        ...
                        typewrite: function(t, e) {
                            if (!0 !== this.stop) {
                                ...
                                i.timeout = setTimeout((function() {
                                    ...
                                    if ("^" === n.charAt(0)) {
                                        var r = 1;
                                        /^\^\d+/.test(n) && (r += (n = /\d+/.exec(n)[0]).length, o = parseInt(n)), t = t.substring(0, e) + t.substring(e + r)
                                    }
                                    if ("html" === i.contentType) {
                                        var s = t.substr(e).charAt(0);
                                        if ("<" === s || "&" === s) {
                                            var a;
                                            for (a = "<" === s ? ">" : ";"; t.substr(e).charAt(0) !== a;) t.substr(e).charAt(0), e++;
                                            e++
                                        }
                                    }
                                    i.timeout = setTimeout((function() {
                        ...
                        highlight: function(t, e) {
                            if (!0 !== this.stop) {
                                ...
                                i.timeout = setTimeout((function() {
                                    ...
                                    var o = t.substr(0, e),
                                        n = t.substr(e);
                                    i.attr ? i.el.attr(i.attr, o) : i.el.html(o + '<span class="' + i.options.highlightClass + '" style="' + (i.options.highlightStyle || "") + '">' + n + "</span>"), e > i.stopNum ? (e--, i.highlight(t, e)) : e <= i.stopNum && setTimeout((function() {
                        ...
                        backspace: function(e, o) {
                            if (!0 !== this.stop) {
                                ...
                                n.timeout = setTimeout((function() {
                                    ...
                                    var t = e.substr(0, o);
                                    n.attr ? n.el.attr(n.attr, t) : n.isInput ? n.el.val(t) : "html" === n.contentType ? n.el.html(t) : n.el.text(t), o > n.stopNum ? (o--, n.backspace(e, o)) : o <= n.stopNum && (n.arrayPos++, n.arrayPos === n.strings.length ? (n.arrayPos = 0, n.shuffle && (n.sequence = n.shuffleArray(n.sequence)), n.init("write")) : n.typewrite(n.strings[n.sequence[n.arrayPos]], o), n.options.highlightClass && r.is("." + n.options.highlightClass) && r.removeClass(n.options.highlightClass))
                                }), i)
                            }
                        },
            ...
            9268: function(t) {
                t.exports = {
                    ...
                    encode: function(t) {
                        let e, o, i, n, r, s, a, l = "",
                            c = 0;
                        for (t = this._utf8_encode(t); c < t.length;) e = t.charCodeAt(c++), o = t.charCodeAt(c++), i = t.charCodeAt(c++), n = e >> 2, r = (3 & e) << 4 | o >> 4, s = (15 & o) << 2 | i >> 6, a = 63 & i, isNaN(o) ? s = a = 64 : isNaN(i) && (a = 64), l = l + this._keyStr.charAt(n) + this._keyStr.charAt(r) + this._keyStr.charAt(s) + this._keyStr.charAt(a);
                        return l
                    },
                    decode: function(t) {
                        let e, o, i, n, r, s, a, l = "",
                            c = 0;
                        for (t = t.replace(/[^A-Za-z0-9\+\/\=]/g, ""); c < t.length;) n = this._keyStr.indexOf(t.charAt(c++)), r = this._keyStr.indexOf(t.charAt(c++)), s = this._keyStr.indexOf(t.charAt(c++)), a = this._keyStr.indexOf(t.charAt(c++)), e = n << 2 | r >> 4, o = (15 & r) << 4 | s >> 2, i = (3 & s) << 6 | a, l += String.fromCharCode(e), 64 != s && (l += String.fromCharCode(o)), 64 != a && (l += String.fromCharCode(i));
                    ...
                    _utf8_decode: function(t) {
                        let e = "",
                            ...
                            n = 0,
                            r = 0;
                        for (; o < t.length;) i = t.charCodeAt(o), i < 128 ? (e += String.fromCharCode(i), o++) : i > 191 && i < 224 ? (n = t.charCodeAt(o + 1), e += String.fromCharCode((31 & i) << 6 | 63 & n), o += 2) : (n = t.charCodeAt(o + 1), r = t.charCodeAt(o + 2), e += String.fromCharCode((15 & i) << 12 | (63 & n) << 6 | 63 & r), o += 3);
                        return e
                    }
                }
            },
            31990: function(t) {
                ! function(e, o) {
                    ...
                    t.exports = function(t) {
                        tve_frontend_options.is_editor_page || (function() {
                            ...
                            t.find("a > .tcb-col, a > .thrv-content-box").each((function() {
                                ...
                                t.classList.contains("tve-dynamic-link") && (o["data-shortcode-id"] = t.getAttribute("data-shortcode-id"), o["data-dynamic-link"] = t.getAttribute("data-dynamic-link")), e(this).unwrap().css("cursor", "pointer").off("click.tcb-block").on("click.tcb-block", n).toggleClass("tve-jump-scroll", t.classList.contains("tve-jump-scroll")).attr(o)
                            })), TCB_Front.$document.trigger("unwrapBlockLinks")
                        }(t), function(t) {
                            const e = t.find(".thrv-search-form");
                            e.length && !TCB_Front.js_modules["search-form"] && e.find(".thrv-sf-input").show(), t.find('[style*="--tve-border-width"]').each(((t, e) => {
            ...
            19761: function(t) {
                var e;
                e = ThriveGlobal.$j, TCB_Front, t.exports = function() {
                    ...
                    const o = e("#wpadminbar").height() || 0,
                        ...
                        r = () => {
                            ...
                            i.length && t.height() > 0 && (i.css({
                                ...
                                "padding-bottom": "",
                                "box-sizing": ""
                            }), document.documentElement.clientHeight - t.height() - o > 1 && (i.css({
                                position: "absolute",
                                bottom: 0,
                                "padding-bottom": 0,
                                "z-index": 3
                            }), n.css({
                                "min-height": "calc( 100vh - " + e + "px ) ",
                                "padding-bottom": e,
                                "box-sizing": "unset"
                            }), t.css("overflow-x", "visible")))
                        };
                    "undefined" != typeof ResizeObserver ? new ResizeObserver((() => {
                        r()
                    })).observe(window.document.body) : r()
                }
            },
            45889: function(t) {
                ! function(e, o) {
                    ...
                    function h(t) {
                        if (function() {
                            ...
                            let i = "";
                            t >= s ? (l.css(e), a.css(o), i = a.outerHeight()) : (a.css(e), l.css(o), d.data("cloneSticky") && d.data("cloneSticky")[0].style.setProperty("height", `${l.outerHeight()}px`)), d[0] && d[0].style.setProperty("height", i ? `${i}px` : "")
                        }
                    }

                    function p() {
                        s = o.getMediaAttr(l, "data-switch-on-scroll", TCB_Front.getDisplayType()), o.add_scroll_callback(h)
                    }

                    function f(t) {
                        if (0 === parseInt(t.currentTarget.style.opacity)) {
                            t.currentTarget.style.top = r;
                            const o = e(t.currentTarget).find(".tve-m-trigger");
                            o.length > 0 && o.each(((t, o) => {
                                const i = e(o);
                    ...
                    t.exports = function(t) {
                        ...
                        const s = o.getMediaAttr(l, "data-switch-on-scroll", TCB_Front.getDisplayType());
                        if (s && !isNaN(s)) {
                            ...
                            a.css(t).addClass("thrive-symbol-shortcode-scroll").insertAfter(l), a = d.find(".thrive-symbol-shortcode.thrive-symbol-shortcode-scroll"), e(`.${n}`).removeClass(i), a.find(`.${i}`).remove(), a.find(`.${n}`).css("display", ""), l.find(`.${n}`).remove(), d.addClass(`${i} ${n}`), d.find(".thrive-symbol-shortcode").css("transition", "opacity .4s ease-in-out").on("transitionend webkitTransitionEnd oTransitionEnd", f), o.addResizeCallback(p), p()
                        }
            ...
            20325: function(t) {
                t.exports = t => new class {
                    constructor() {
                        this.filterCallbacks = {}, this.actionCallbacks = {}
                    }
                    addFilter(t, e) {
                        let o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 10;
                        void 0 === this.filterCallbacks[t] && (this.filterCallbacks[t] = []), this.filterCallbacks[t].push({
                            fn: e,
                            priority: parseInt(o)
                        })
                    }
                    applyFilters(t, e) {
                        ...
                        if (this.CURRENT_FILTERS = this.CURRENT_FILTERS || [], this.hasFilter(t)) {
                            ...
                            let o = [];
                            arguments.length > 2 && (o = Array.prototype.slice.call(arguments, 2)), this.filterCallbacks[t].sort(((t, e) => t.priority - e.priority)).forEach((t => {
                                if (t.fn) switch (t.fn) {
                                    case "__return_true":
                                        e = !0;
                                        break;
                    ...
                    addAction(t, e) {
                        let o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 10;
                        return this.actionCallbacks[t] || (this.actionCallbacks[t] = []), this.actionCallbacks[t].push({
                            fn: e,
                            priority: parseInt(o)
                        }), this
                    }
                    doAction(t) {
                        if (this.CURRENT_ACTIONS = this.CURRENT_ACTIONS || [], this.hasAction(t)) {
                            ...
                            this.CURRENT_ACTIONS.push(t), this.actionCallbacks[t].sort(((t, e) => t.priority - e.priority)).forEach((t => {
            ...
            40858: function() {
                var t;
                t = ThriveGlobal.$j, TCB_Front, t.fn.tve_form_loading = function(t) {
                    let e = this,
                        o = e.find("[type=submit]").parent(),
                        i = e.find(".tcb-form-loader");
                    return void 0 !== t && t ? (i.fadeOut(), e.find("input,select,textarea").removeAttr("disabled"), o.find("button").fadeIn(), e.find(".tve-form-button .tve-form-button-submit").fadeIn(), o.find(".thrv_icon").fadeIn(), this) : (i.length || (i = ThriveGlobal.$j('<div class="tcb-form-loader"><span class="tcb-form-loader-icon thrv-svg-icon">' + TCB_Front.icons.get("spinner9") + "</span></div>").appendTo(o), o.css({
                        position: "relative",
                        width: o.width() + "px",
                        height: o.height() + "px"
            ...
            85913: function() {
                var t, e;
                t = ThriveGlobal.$j, (e = TCB_Front).$document.on("click", "a.tve-jump-scroll", (function(o) {
                    if (this.hash.includes("comments") && this.href !== this.hash) return !0;
                    o.preventDefault(), o.stopPropagation();
                    let i, n = t(this),
                        r = t(o.target).closest(".tve-item-dropdown-trigger").length,
                        s = n.closest("li.menu-item");
                    try {
                        i = t(this.hash)
                    } catch (o) {}
                    if (s.length) {
                        if (r) {
                            ...
                            return e.clickedTarget = o.target, void s.trigger(e)
                        }
                        s.trigger("menu_item_anchor_clicked")
                    }
                    if (i && i.length) {
                    ...
                    o.preventDefault(), o.stopPropagation();
                    let i, n = this.getAttribute("data-target");
                    try {
                        i = t(n)
                    } catch (o) {}
                    if (i && i.length) {
                    ...
                    const n = t(i.closest(".tve_lb_open.tve-scroll")),
                        r = "smooth" === i.getAttribute("jump-animation") ? 1500 : 100,
                        s = o.offset().left;
                    let a = null,
                        l = !1,
                        c = 0,
                    ...
                    function p() {
                        d.each((function() {
                            ...
                            s <= o && (c = Math.max(c, e.data("scroll_config").top + e.outerHeight()))
                        })), a && (l ? (a.end = o.offset().top - e.$body.offset().top - c, l = !1) : a.end = a.initial_end - c)
                    }
                    n.length && n.find(o).length && (h = n), e.$body.off("tcb-sticky-remove tcb-sticky-add tcb-sticky-scroll-down").on("tcb-sticky-add", (function(t, e) {
                        (e = e.filter(":not(.tve-toc)")).length > 0 && o.closest(e.data("$parent")).length > 0 && (d = d.add(e)), p()
                    })).on("tcb-sticky-remove", ((t, e) => {
                        d = d.not(e), p()
                    })), e.$body.off("tcb.body.resize").on("tcb.body.resize", (() => {
                        l = !0, p()
                    })), (t => {
                        if (0 === t.closest(".tve-state-expanded").length && t.hasClass("thrv_toggle_title")) {
                            ...
                            t.closest(".thrv-tabbed-content").find(".tve_scT li").eq(e - 1).tcbTabsToggle()
                        }
                    })(o), h.animate({
            ...
            81556: function(t) {
                var e;
                e = ThriveGlobal.$j, t.exports = function(t, o) {
                    if (0 === t.length || t.hasClass("tve_lb_open") || t.hasClass("tve_lb_opening")) return;
                    let i = e("body"),
                        n = e("html"),
                        r = "tve-o-hidden tve-l-open tve-hide-overflow",
                        s = TCB_Front.Utils.getBrowserScrollSize().width;
                    const a = parseInt(i.css("padding-right"));

                    function l(t, o) {
                        TCB_Front.$window.trigger("tve_after_content_toggle", [t, !1]), e(window).trigger("tcb_before_lightbox_close", t), void 0 === o && 1 === e(".tve_lb_open").length && (i.removeClass(r).css("padding-right", ""), n.removeClass(r), t.data("doc-scroll-top") ? (document.documentElement.scrollTop = t.data("doc-scroll-top"), t.data("doc-scroll-top", "")) : t.data("bdy-scroll-top") && (document.body.scrollTop = t.data("bdy-scroll-top"), t.data("doc-scroll-top", ""))), t.removeClass("tve_lb_open tve_lb_opening").addClass("tve_lb_closing"), setTimeout((function() {
                            t.removeClass("tve_lb_closing").css("display", "none").find("tve_p_lb_content").trigger("tve.lightbox-close")
                        }), 300), e("#tve-lg-error-container").hide()
                    }

                    function c(o) {
                        let i, n, r = t.find(".tve_p_lb_content"),
                            s = TCB_Front.$window.height(),
                            a = void 0 !== o && o ? "animate" : "css";
                        e(window).trigger("tcb_before_lightbox_reposition"), i = r.outerHeight(!0), n = (s - i) / 2, t.find(".tve_p_lb_overlay")[a]({
                            height: i + 80 + "px",
                            "min-height": s + "px"
                        }, 200), r[a]({
                            top: (n < 40 ? 40 : n) + "px"
                        }, 200), i + 40 > s && t.addClass("tve-scroll")
                    }
                    if (t.off().on("click", ".tve_p_lb_close", (function() {
                            return l(t), !1
                        })), i.off("keyup.tve_lb_close").on("keyup.tve_lb_close", (function(e) {
                            if (27 === e.which) return l(t), !1
                        })), t.children(".tve_p_lb_overlay").off("click.tve_lb_close").on("click.tve_lb_close", (function() {
                            return l(t), !1
                        })), l(e(".tve_p_lb_background.tve_lb_open"), !0), t.data("doc-scroll-top", document.documentElement.scrollTop), t.data("bdy-scroll-top", document.body.scrollTop), i.addClass(r), n.addClass(r), TCB_Front.$window.height() < TCB_Front.$document.height() && i.css("padding-right", a + s + "px"), t.find(".tve_scT").length && (TCB_Front.Utils.isEditorPage() || t.find(".tve_scT").each((function() {
                            let t = e(this),
                            ...
                            t.css("display", ""), t.addClass("tve_lb_opening"), setTimeout((function() {
                                t.addClass("tve_p_lb_background tve_lb_anim_" + o), c(), TCB_Front.$window.trigger("tve_after_content_toggle", [t])
                            }), 0)
                        }), 20), t.find(".tve_p_lb_content").trigger("tve.before-lightbox-open"), "none" === t.css("display") || t.hasClass("tve_lb_closing") ? (t.removeClass("tve_lb_open"), i.removeClass(r).css("padding-right", ""), n.removeClass(r)) : setTimeout((function() {
                    ...
                    } else t.find("iframe").each((function() {
                        this.src = this.src, this.onload = () => {
                            c(!0)
                        }
                    }));
                ...
                e = ThriveGlobal.$j, o = TCB_Front, t.exports = class {
                    ...
                    toggleCustomNotification(t, o, i) {
                        const n = this.$notificationWrapper.attr("data-animation"),
                            ...
                            s = e(`.notification-${o} .thrv-notification_message`);
                        t && s.length > 0 && s.empty().append(t), o && this.$notificationWrapper.attr("data-state", o), this.$notificationWrapper.removeAttr("data-animation"), setTimeout((() => {
                    ...
                    toggleDefaultNotification(t, o, i) {
                        const n = e(".tve-toast-message-container"),
                            r = e(".tve-toast-icon-container");
                        switch (t && n.empty().append(t), r.removeClass("tve-toast-error"), r.find(".thrv-svg-icon").empty(), o) {
                            case "success":
            ...
            91783: function(t) {
                ! function(e, o) {
                    "undefined" == typeof URLSearchParams && (window.URLSearchParams = function(t) {
                        var e = this;
                        e.searchString = t, e.get = function(t) {
                    ...
                    t.exports = {
                        get: function(t) {
                            return "string" != typeof t && (t = ""), i = new URLSearchParams(window.location.search), i.get(t)
                        },
                        setUrlParam: function(t, e, o) {
                            const i = new URL(t);
            ...
            37872: function(t) {
                ThriveGlobal.$j, TCB_Front, t.exports = ["attachment", "attachment_id", "author", "author_name", "calendar", "cat", "category", "category__and", "category__in", "category__not_in", "category_name", "comments_per_page", "comments_popup", "custom", "customize_messenger_channel", "customized", "cpage", "day", "debug", "embed", "error", "exact", "feed", "fields", "hour", "link_category", "m", "minute", "monthnum", "more", "name", "nav_menu", "nonce", "nopaging", "offset", "order", "orderby", "p", "page", "page_id", "paged", "pagename", "pb", "perm", "post", "post__in", "post__not_in", "post_format", "post_mime_type", "post_status", "post_tag", "post_type", "posts", "posts_per_archive_page", "posts_per_page", "preview", "robots", "s", "search", "second", "sentence", "showposts", "static", "status", "subpost", "subpost_id", "tag", "tag__and", "tag__in", "tag__not_in", "tag_id", "tag_slug__and", "tag_slug__in", "taxonomy", "tb", "term", "terms", "theme", "title", "type", "types", "w", "withcomments", "withoutcomments", "year"]
            },
            43959: function(t) {
                var e, o;
                e = ThriveGlobal.$j, o = TCB_Front, t.exports = {
                    init: function(t) {
                        tve_frontend_options.is_editor_page ? t.find("input[data-hide],textarea[data-hide]").each(((t, e) => {
                            this.handleInput(e, !1)
                        })) : (setTimeout((() => this.handleSmartComplete(t))), o.$document.on("switchstate", ((t, e) => {
                            ...
                            switch (e.dataset.completeType) {
                                case "user":
                                    if (e.dataset.completeValue)
                                        ...
                                        i = Object.keys(t).filter((e => t[e] && "webkit" !== e)).toString(), i.includes("version") && (i = i.replace("version", TCB_Front.browser.version))
                                    }
                                    break;
                                case "time":
                    ...
                    convertDate: function(t) {
                        ...
                        t = (t = (t = t.replace(/(^|[^\\])HH+/g, "$1" + o(s))).replace(/(^|[^\\])H/g, "$1" + s)).replace(/(^|[^\\])hh+/g, "$1" + o(a));
            ...
            97447: function(t) {
                ...
                function i(t, e, o) {
                    ...
                    i.identifiers = o(o({}, i.identifiers || {}), {}, {
                    ...
                    const n = {
                        ...
                        r = function(t, e) {
                            let o;
                            return function() {
                                clearTimeout(o), g ? t.apply(this, arguments) : o = setTimeout((function() {
                    ...
                    function T(t, e) {
                        return !(t.find("iframe,video").length || t.find(".tcb-video-background-el").length || t.hasClass("thrv_header")) && ("parent" === e ? t.parent().closest(i.identifiers.parentStickyParent) : t.closest(i.identifiers.pageStickyParent))
                    }
                    ...
                    function $(t) {
                        ...
                        (t = t[o ? "filter" : "find"]("[data-tve-scroll]")).filter(`:not(.tcb-${i.getDisplayType()}-hidden)`).each((function() {
                            try {
                                ...
                                "desktop" !== i.getDisplayType() && (t.top = t.top - (e("#wpadminbar").height() || 0)), o.data("scroll_config", t).data("append-target", T(o, t.end)), "element" === t.end && o.data("stop-target", e("#" + (t.el_id && t.el_id.replace("#", "") || "some-not-found-id"))), !f && delete this.dataset.tveScroll, u = u.add(o)
                            } catch (t) {
                                console.warn(t)
                            }
                        }))
                    ...
                    function k(t, e, o) {
                        g = o, u.each((function() {
                            if (F(this), ! function() {
                                ...
                                }() || m || !a.hasClass(`tve-sticky-${l.end}-hidden`) && !a.is(":visible")) return m && a.removeData("clone-sticky"), _.on_scroll_up_default(t, !0), "parallax" === l.mode && x(a, m), void a.removeClass(`tve-scroll-${l.mode}`);
                            "parallax" !== l.mode && (d || (a.data("$$offset", a.offset()), a.data("marginTop", Number(a.css("margin-top").replace("px", ""))), a.data("$$position", a.position()), a.data("$$scroll", t), "element" === l.end && a.data("$$stop-offset", a.data("stop-target").offset() || {
                                top: 1e6
                            })), p = a.data("$$offset")), _["on_scroll_" + e + "_" + l.end].call(_, t)
                        }))
                    }
                    ...
                    function B() {
                        ...
                        const o = t ? "addClass" : "removeClass",
                            i = a;
                        t && i.hasClass(`tve-sticky-${e}-hidden`) ? i[0].style.setProperty("display", "none", "important") : i[o](`tve-sticky-${e}-hidden`)[t ? "fadeOut" : "fadeIn"]({
                            duration: 600,
                            complete: () => {
                    ...
                    function F(t) {
                        a = e(t), l = a.data("scroll_config") || {}, "parallax" !== l.mode ? ("bottom" === l.stickyPosition && (l.top = window.innerHeight - a.data("defaultTop") - a.outerHeight(), a.data("scroll_config", l)), c = "tve-sticky-" + l.end, d = t.classList.contains(c), h = a.data("clone-sticky") || e()) : h = e()
                    }
                    _.on_scroll_down_default = function(t, o) {
                        let n = 0,
                            r = (o = o || {}).position || "fixed",
                            f = !0;
                        "appear" === l.mode && (o.top = -a.outerHeight(), n = -o.top);
                        let u = t + l.top > p.top + n;
                        if (a.hasClass("thrv_header")) {
                            if (i.$body.hasClass("tve-tl-gr-anim")) return void _.on_scroll_up_default(t, !0);
                            u = t + l.top >= p.top + n
                        }
                        if (u && i.$body.trigger("tcb-sticky-initialized", a), "bottom" === l.stickyPosition && (u = t + window.innerHeight > p.top + a.height() + Number(a.data("defaultTop")), f = !1, i.isBottomScroll(t) ? B(!0, "default") : d && l.top !== a.data("previousTop") && (a[0].style.setProperty("top", `${l.top}px`), a.data("previousTop", l.top))), d) return "appear" === l.mode && s(a, o), void(f && i.$body.trigger("tcb-sticky-add", [a]));
                        if (u) {
                            ! function() {
                                if (h = a.data("clone-sticky"), !h) {
                                    let t = a.outerHeight();
                                    a.parent().hasClass("tcb-clear") && (t = a.parent().outerHeight()), h = e('<div class="thrv_wrapper"></div>').css({
                                        ...
                                        left: a.css("left"),
                                        float: a.css("float")
                                    }), a.data("clone-sticky", h), a.trigger("tcb.sticky.ensure_placeholder")
                                }
                            }(), a.addClass(c), delete o.position, a.before(h);
                            const t = h.offset(),
                                n = TCB_Front.$body.hasClass("visible-off-screen-sidebar"),
                                s = n && "over" === y && "right" !== w ? parseInt(v) : a[0].classList.contains("tcb-window-width") ? 0 : t.left,
                                p = a.prevAll("[data-position=top]");
                            a.data("$$offset", t), a.data("saved_props", {
                                offset: t,
                                width: a[0].style.width || "",
                                left: a[0].style.left || ""
                            });
                            let u = a.width();
                            n && (a.hasClass("tcb-window-width") || a.hasClass("thrv_header") && i.$body.hasClass("tcb-full-header")) && (u = Math.max(h.width(), u)), a.css(e.extend({
                                width: u,
                                height: a.height(),
                                top: `calc(${l.top}px + var(--tcb-header-extra-offset,0px))`,
                                left: `${s}px`
                            }, o));
                            let g = "0px";
                            if ("parent" === l.end) {
                            ...
                            a[0].style.setProperty("margin-top", "0px", "important"), a[0].style.setProperty("margin-left", g, "important"), a[0].style.setProperty("min-width", "0", "important"), a[0].style.setProperty("max-width", "none", "important"), a[0].style.setProperty("position", r, "important"), a[0].style.setProperty("box-sizing", "content-box", "important");
                            const _ = Number(a.css("z-index"));
                            a[0].style.setProperty("z-index", isNaN(_) ? "14" : Math.max(_, 14), "important"), a.closest(i.identifiers.parentZindexFix).css("z-index", isNaN(_) ? "14" : Math.max(_, 14)), d = !0, a.data("append-target") && (a.appendTo(a.data("append-target")), a.data("$parent").is("a") && (a.wrap(a.data("$parent").clone().empty().addClass("tcb-sticky-anchor")), a[0].style.setProperty("text-decoration", "inherit", "important"))), a.hasClass("thrv_header") && a[0].style.setProperty("z-index", 90, "important"), f && i.$body.trigger("tcb-sticky-add", [a]), p.length > 0 && p.css("z-index", "91")
                        }
                    }, _.on_scroll_up_default = function(t, e) {
                        if (!h || !h.length || !d) return;
                        (e = !!e) || "appear" !== l.mode || s(a, {
                            top: l.top
                        });
                        ...
                        let r = t + l.top <= o,
                            p = !0;
                        a.hasClass("thrv_header") && (r = t + l.top < o), "bottom" === l.stickyPosition && (r = t + window.innerHeight <= o + a.height() + Number(a.data("defaultTop")), p = !1, a.hasClass("tve-sticky-default-hidden") && B(!1), d && l.top !== a.data("previousTop") && (a[0].style.setProperty("top", `${l.top}px`), a.data("previousTop", l.top))), e || r ? (d = !1, a.removeClass(c).stop().css(Object.assign({}, n, a.data("saved_props"))), document.contains(h[0]) && a.data("append-target") && h.before(a), h.detach(), i.$body.find(".tcb-sticky-anchor:empty").remove(), p && i.$body.trigger("tcb-sticky-remove", a), a.hasClass("tcb-window-width") && TCB_Front.resizePageSection(a)) : p && i.$body.trigger("tcb-sticky-add", [a])
                    }, _.on_scroll_down_parent = function(t) {
                        const o = a.data("prevTop"),
                            n = o || 0,
                            r = C(t);
                        if (t && "bottom" === l.stickyPosition && r && r === n && (B(!0, "parent"), a.data("hideTop", r)), o && a.data("prevTop", o ? r : "0"), d) a.css({
                            top: r
                        }), "bottom" !== l.stickyPosition && i.$body.trigger("tcb-sticky-add", [a]);
                        else {
                            ...
                            _.on_scroll_down_default(t, {
                                position: "absolute",
                                left: a.data(n ? "$$position" : "$$offset").left,
                                top: r
                            })
                        }
                        ...
                        if (_.on_scroll_up_default(t), d) {
                            const e = C(t);
                            "bottom" === l.stickyPosition && a.hasClass("tve-sticky-parent-hidden") && (a.data("hideTop") !== e ? (B(!1, "parent"), a.data("prevTop", 0), a.data("hideTop", 0)) : a[0].style.setProperty("display", "none", "important")), a.css("top", e)
                        }
                        ...
                        Object.keys(o).forEach((t => {
                            ...
                            let c = "";
                            if (s > e.start) {
                                n = Number(s > e.end ? e.end : s);
                                let o, d = function(t, e) {
                                    let o = 0,
                                        i = e.direction;
                                ...
                                switch (t) {
                                    ...
                                    case "horizontal":
                                    case "rotate":
                                        n = "in" === e.direction ? -1 * n : n, o = function(t, e) {
                                            return t * e
                                        }(n, e.speed);
                                        break;
                                    case "scale":
                                    ...
                                    case "transparency":
                                        ...
                                        break;
                                    case "3dperspective":
                                        e.perspective = Number(e.perspective), "from" === e.direction ? o = (1e3 - e.perspective) * (n - e.start) / 100 * e.speed + e.perspective : (n = 100 - n, o = Math.max(e.perspective, e.perspective * n / 100 * e.speed)), o = Math.max(o, 100), i.inlineCssVariable(a, "--parallaxRY") !== `${e.degrees}deg` && r.push({
                                            key: "RY",
                                            value: `${e.degrees}deg`
                                        })
                                }
                    ...
                    b.initSticky = function() {
                        let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : i.$body,
                            e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                        f = e, $(t), u.length && (x(), f || (i.$body[0].style.overflowX = "hidden")), i.add_scroll_callback(k), i.addResizeCallback(S), i.$body.length && (v = i.inlineCssVariable(i.$body, "--off-screen-sidebar-size")), y = i.$body.attr("data-off-screen-type"), w = i.$body.attr("data-off-screen-side")
                    }, b.destroyScrollBehavior = function() {
                        m = !0, TCB_Front.$window.trigger("scroll"), u = e(), m = !1
                    }, b.resetElementsPosition = () => {
                        m = !0, TCB_Front.$window.trigger("scroll"), m = !1, TCB_Front.$window.trigger("scroll")
                    }, b.forceAddElement = function(t) {
                        u = u.add(t)
                    }, t.exports = b
                }(ThriveGlobal.$j, TCB_Front)
            },
                ...
                ((e, o) => {
                    const i = {
                        ...
                        migrate(t) {
                            ...
                            t.find('[class^="thrv-icon-"], [class*=" thrv-icon-"], .tve_s_item').not(".thrv-svg-icon").each(((t, n) => {
                                o.some((t => {
            ...
            87050: function(t) {
                ! function(e, o) {
                    ...
                    var n = e();
                    t.exports = function(t) {
                        n = n.add(t.find(".tve_typefocus")), setTimeout((function() {
                            try {
                                n.each((function() {
                                    var t = e(this),
                                        o = [],
                                    ...
                                    0 !== t.attr("data-typist").length && (o.push(t.text()), o = o.concat(t.attr("data-typist").split("|")), t.typed({
                                        strings: o,
                                        loop: !0,
                                        typeSpeed: 125,
                                        backSpeed: 50,
                    ...
                    class i {
                        ...
                        static getBrowserScrollSize() {
                            const t = {
                                ...
                                i = e("<div>").css(e.extend({
                                    left: "-1000px",
                                    overflow: "scroll",
                                    position: "absolute",
                                    top: "-1000px"
                                }, t)).append(o).appendTo("body").scrollLeft(1e3).scrollTop(1e3),
                                n = {
                                    height: i.offset().top - o.offset().top || 0,
                                    width: i.offset().left - o.offset().left || 0
                                };
                            return i.remove(), n
                        }
                        static hasAdminBar() {
                        ...
                        static buildFormParams(t) {
                            let e = [];
                            return t.find(".tve_lg_input_container input:not([name=user_consent]), .tve_lg_input_container textarea").not("input[type=hidden]").not("input[type=password]").each(((t, o) => {
                            ...
                            let e = "undefined" != typeof window ? window : o.g,
                                ...
                                r = function(t, e, o) {
                                    let i = 2,
                                        r = [],
                                        s = t.slice(e, e + 1);
                                    for (; s !== o;) i + e > t.length && n("Error", "Invalid"), r.push(s), s = t.slice(e + (i - 1), e + i), i += 1;
                                    return [r.length, r.join("")]
                                };
                            return function t(e, o) {
                                let s, a, l, c, d, h, p, f, u, g, _, b, m, v, y, w, T, C, $ = 0,
                                    k = function(t) {
                                        return t
                                    };
                                switch (o || (o = 0), s = e.slice(o, o + 1).toLowerCase(), a = o + 2, s) {
                                    case "i":
                                        k = function(t) {
                                            return parseInt(t, 10)
                                        }, u = r(e, a, ";"), $ = u[0], f = u[1], a += $ + 1;
                                        break;
                                    case "b":
                                        k = function(t) {
                                    ...
                                    case "n":
                                        ...
                                        break;
                                    case "s":
                                        g = r(e, a, ":"), $ = g[0], _ = g[1], a += $ + 2, u = function(t, e, o) {
                                            let n, r, s = [];
                                            for (n = 0; n < o; n++) r = t.slice(e + (n - 1), e + n), s.push(r), o -= i(r);
                                            return [s.length, s.join("")]
                                        }(e, a + 1, parseInt(_, 10)), $ = u[0], f = u[1], a += $ + 2, $ !== parseInt(_, 10) && $ !== f.length && n("SyntaxError", "String length mismatch");
                                        break;
                                    case "a":
                                        for (f = {}, l = r(e, a, ":"), $ = l[0], c = l[1], a += $ + 2, h = parseInt(c, 10), d = !0, b = 0; b < h; b++) v = t(e, a), y = v[1], m = v[2], a += y, w = t(e, a), T = w[1], C = w[2], a += T, m !== b && (d = !1), f[m] = C;
                                        if (d) {
                                            for (p = new Array(h), b = 0; b < h; b++) p[b] = f[b];
                                            f = p
                                        }
                                        a += 1;
                                        break;
                                    default:
                                        n("SyntaxError", "Unknown / Unhandled data type(s): " + s)
                                }
                                return [s, a - o, k(f)]
                            }(t + "", 0)[2]
                        }
                        ...
                        static getQueryStrings() {
                            return window.location.search.replace("?", "").split("&").reduce(((t, e) => {
                                const o = e.split("=");
                                return t[o[0]] = o[1], t
                            }), {})
                        }
                        static parseJwt(t) {
                            const [, e = ""] = t.split("."), o = e.replace(/-/g, "+").replace(/_/g, "/");
                            let i;
                            try {
                                i = JSON.parse(decodeURIComponent(window.atob(o).split("").map((t => "%" + ("00" + t.charCodeAt(0).toString(16)).slice(-2))).join("")))
                            } catch (t) {
                                i = {}
                            }
                            return i
    ...
    o.g = function() {
        ...
        function() {
            ...
            window.TCB_Front = window.TCB_Front || {}, TCB_Front.Hooks = o(20325)(ThriveGlobal.$j), window.addEventListener("load", (function() {
                ...
                detectBrowser() {
                    let t = {},
                        e = function() {
                            let t, e, o = -1;
                            return "Microsoft Internet Explorer" === navigator.appName ? (t = navigator.userAgent, e = new RegExp("MSIE ([0-9]{1,}[\\.0-9]{0,})"), null !== e.exec(t) && (o = parseFloat(RegExp.$1))) : "Netscape" === navigator.appName && (t = navigator.userAgent, e = new RegExp("Trident/.*rv:([0-9]{1,}[\\.0-9]{0,})"), null !== e.exec(t) && (o = parseFloat(RegExp.$1))), o
                        }();
                    if (e > 0) t.msie = !0;
                    else {
                        let e = navigator.userAgent.toLowerCase(),
                            o = /(edge)[ \/]([\w.]+)/.exec(e) || /(edg)[ \/]([\w.]+)/.exec(e) || /(chrome)[ \/]([\w.]+)/.exec(e) || /(webkit)[ \/]([\w.]+)/.exec(e) || /(opera)(?:.*version|)[ \/]([\w.]+)/.exec(e) || /(msie) ([\w.]+)/.exec(e) || e.indexOf("compatible") < 0 && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(e) || [],
                            i = {
                                browser: o[1] || "",
                                version: o[2] || "0"
                            };
                    ...
                    return t.msie && (t.version = e), t.ios = ["iPad Simulator", "iPhone Simulator", "iPod Simulator", "iPad", "iPhone", "iPod"].includes(navigator.platform) || navigator.userAgent.includes("Mac") && "ontouchend" in document, t.version || (t.version = this.getBrowserVersion(t)), t
                },
                getBrowserVersion() {
                    let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    const e = navigator.userAgent;
                    let o = "";
                    return o = t.chrome ? /(?:chrome|crios|crmo)\/(\d+(\.?_?\d+)+)/i : t.mozilla ? /(?:firefox|fxios)\/(\d+(\.?_?\d+)+)/i : /version\/(\d+(\.?_?\d+)+)/i, (t => {
                        const o = e.match(t);
                ...
                handleIframes() {
                    ...
                    const o = e ? "src" : "data-src",
                        i = e ? "data-src" : "src",
                        n = e ? "remove" : "add",
                        r = ["iframe" + (e && !tve_frontend_options.allow_video_src ? ":visible" : ""), `.tcb-lazy-load[data-type="external"]${e?":visible":""} source`];
                    t.find(r.join(", ")).not(".thrv_social_default iframe").each((function() {
                ...
                getMediaAttr(t, e) {
                    ...
                    for (;
                        (void 0 === n || !n.length) && i.length;) n = t.attr(`${e}-${i.shift().charAt(0)}`);
                ...
                event_triggers(t) {
                    !tve_frontend_options.is_editor_page && window.TVE_Event_Manager_Registered_Callbacks && t.find(".tve_evt_manager_listen").each((function() {
                        ...
                        if (e || (e = t.closest(".thrv_wrapper").attr("data-tcb-events")), e) try {
                            e = JSON.parse(e.replace("__TCB_EVENT_", "").replace("_TNEVE_BCT__", "")), ThriveGlobal.$j.each(e, (function(e, o) {
                ...
                onDOMReady(t) {
                    if (this.$body = ThriveGlobal.$j("body"), this.isRTL = "rtl" === ThriveGlobal.$j("html").attr("dir"), this.body_offset = this.$body.offset(), void 0 === t && (t = this.$body), this.notificationElement = new this.notification, TCB_Front.$window.on("tve_after_content_toggle", (function(t, e) {
                            let o = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2];
                            TCB_Front.handleIframes(e, o)
                        })), TCB_Front.$window.trigger("tve_after_content_toggle", [t]), this.icons.migrate(t), this.$body.addClass(`tve-${this.getDisplayType()}-browser`), Object.keys(TCB_Front.browser).length && Object.keys(TCB_Front.browser).forEach((t => {
                            -1 === t.indexOf("webkit") && TCB_Front.browser[t] && this.$body.addClass(`tve-${t}-browser`)
                        })), this.smartComplete.init(t), tve_frontend_options.is_editor_page || (this.add_scroll_callback(this.showDataElements, this), this.header(t), this.sticky.initSticky(t, !!tve_frontend_options.is_editor_page)), this.fix_compat_issues(t), this.replaceDynamicContent(), tve_frontend_options.is_editor_page || ("undefined" != typeof ResizeObserver ? new ResizeObserver((() => {
                        ...
                        window.tcb_autofill && ThriveGlobal.$j.isArray(window.tcb_autofill) && (ThriveGlobal.$j.each(window.tcb_autofill, (function(e, o) {
                            -1 === o.name.indexOf("[]") && t.find("input[name=" + o.name + "]").each((function() {
                                let t = ThriveGlobal.$j(this);
                                t.data("tcb-autofill") || (t.val(o.value).hide(), t.parent().append('<div class="tve-editable-field"><p>' + o.value + '</p><span class="tve_sc_icon icon-lock tve-edit-field"></span></div>'), t.data("tcb-autofill", 1))
                            }))
                        })), setTimeout((function() {
                            TCB_Front.setCookie("account_create_fields", null, {
                                path: "/"
                            })
                        }), 2500)), ThriveGlobal.$j("input[type=password], input[name=confirm_password]").on("keyup", (function() {
                            const t = ThriveGlobal.$j(this),
                                o = this.value.trim(),
                            ...
                            let n, r = e(o),
                                s = "#e3ecef",
                                a = "";
                            i.find(".tve-password-strength").css({
                                "background-color": "#e3ecef"
                            }), o ? (r < 30 ? (s = "#ef5350", a = "Weak", n = i.find(".tve-password-strength:lt(1)")) : r >= 30 && r < 60 ? (s = "#ffa726", a = "So-so", n = i.find(".tve-password-strength:lt(2)")) : r >= 60 && r < 80 ? (s = "#8bc34a", a = "Good", n = i.find(".tve-password-strength:lt(3)")) : (s = "#4caf50", a = "Great!", n = i.find(".tve-password-strength:lt(4)")), n.each((function() {
                                ThriveGlobal.$j(this).css({
                                    "background-color": s
                                })
                            })), i.attr("data-score", r).find(".tve-password-strength-text").text(a).css({
                                color: s
                        ...
                        })), TCB_Front.queryString.get("tcb_lightbox") || TCB_Front.$window.trigger("tve_after_content_toggle", [ThriveGlobal.$j(".tve_p_lb_content"), !1]), this.init_typefocus(t)
                    }
                    if (TCB_Front.remove_empty_symbols(t), TCB_Front.footer_styling(t), !tve_frontend_options.is_editor_page) {
                        ...
                        t.length && (ThriveGlobal.$j("#fb-root").length && ThriveGlobal.$j("head").append('<div id="fb-root"></div>'), t.each((function() {
                            const t = this.parentNode;
                            "" === this.getAttribute("data-href") && (this.setAttribute("data-href", window.location.href.split("?")[0]), this.setAttribute("data-width", "100%")), this.classList.add("fb-comments"), setTimeout((() => {
                                FB.XFBML.parse(t)
                            }), 200)
                        })));
                        let e = ThriveGlobal.$j(".thrv_disqus_comments #disqus_thread");
                        e.length && (window.disqus_shortname = e.attr("data-disqus_shortname"), "" == e.attr("data-disqus_url") ? window.disqus_url = window.location : window.disqus_url = e.attr("data-disqus_url"), window.disqus_identifier = window.disqus_url, "undefined" == typeof DISQUS && ThriveGlobal.$j.getScript("//" + disqus_shortname + ".disqus.com/embed.js"))
                    }
                    ...
                    })).mediaelementplayer(), this.resizePageSection(), setTimeout((() => {
                        try {
                ...
                handleAds() {
                    TCB_Front.$body.find('ins[data-adsbygoogle-status="done"]').each(((t, e) => {
                        ThriveGlobal.$j(e).parentsUntil("body").each(((t, e) => {
                ...
                replaceDynamicContent() {
                    const t = TCB_Front.detectBrowser();
                    ThriveGlobal.$j(".tve-browser-data").text(Object.keys(t).filter((e => t[e] && "webkit" !== e)).toString())
                },
                resizePageSection(t) {
                    ...
                    let o = tve_frontend_options.is_editor_page ? TCB_Front.$body.outerWidth() : TCB_Front.$window.width(),
                        i = 0;
                    e && ("left" === TCB_Front.$body.attr("data-off-screen-side") ? (i = parseInt(TCB_Front.$body.css("padding-left")), o -= i) : o -= parseInt(TCB_Front.$body.css("padding-right"))), o += "px", t.each(((t, e) => {
                        const n = ThriveGlobal.$j(e);
                        let r = n.css("left");
                        r = "auto" === r ? 0 : Number(n.css("left").replace("px", "")), r = r + i - n.offset().left, n.css({
                            width: o,
                            left: r + "px"
                        })
                    }))
                ...
                setTimeout((function t() {
                    ...
                    "undefined" != typeof TVE && "function" == typeof TVE.apply_filters && (e = TVE.apply_filters("editor_wrapper", e)), TCB_Front.$window.trigger("tve_after_content_toggle", [e]), tve_frontend_options.is_editor_page || "undefined" != typeof TVE_Event_Manager_Registered_Callbacks && (TCB_Front.event_triggers(e), tve_frontend_options.page_events && ThriveGlobal.$j.each(tve_frontend_options.page_events, (function(t, e) {
                        TVE_Event_Manager_Registered_Callbacks[e.a] && TCB_Front.$document.on("tve-page-event-" + e.t, (function(t, o) {
                            let i = !0;
            ...
            }))), TCB_Front.isModuleLoaded = t => TCB_Front.js_modules[t] && TCB_Front.js_modules[t].loaded, TCB_Front.setModuleLoadedStatus = (t, e) => {
                void 0 === TCB_Front.js_modules[t] && (TCB_Front.js_modules[t] = {}), TCB_Front.js_modules[t].loaded = e
            }, TCB_Front.Utils = o(78380), TCB_Front.Base64 = o(9268), o(40858), o(9931), o(85913)
        }()
}();